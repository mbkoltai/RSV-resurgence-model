...
write_csv(bind_rows(lapply(list.files(path=parall_foldername,pattern="init_cond_start*"),
   function(x) read_csv(paste0(parall_foldername,x)))),paste0(parall_foldername,"initconds_all.csv"))
