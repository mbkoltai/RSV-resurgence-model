# these are scripts for the first set of (smaller) param scans that were done without parallelisation
# we decided to rewrite the manuscript after the Summer of 2021, so these became partly obsolete
