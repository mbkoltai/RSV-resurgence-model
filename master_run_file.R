...
#     c(1,1.125,1.25),c(1.25,1.375,1.5),c(1.25,1.375,1.5),c(1.25,1.375,1.5))[[x]],R0=list( (12:14)/10,(12:14)/10,
#       seq(13,16,1.5)/10,seq(15,18,1.5)/10, seq(14,20,2)/10, seq(15,18,1)/10,(18:20)/10,(24:26)/10)[[x]])))))
npi_dates<-as.Date(c("2020-03-26","2021-05-17"))
partable <- bind_rows(expand.grid( list(exp_dep=(1:8)/4,age_dep=(1:8)/8,seasforc_width_wks=8,peak_week=50) ))
...
# stat_sol_allparets=matrix(0,nrow=(n_compartment+1)*n_age*n_inf,ncol=nrow(partable))
# NPI dates
# npi_dates<-as.Date(c("2020-03-26","2021-05-17"))
...
mat_imm_flag <- TRUE
mat_imm_inds<-list(fun_sub2ind(i_inf=1,j_age=1,"R",c("S","I","R"),n_age,3),
